...
{
  public  class specialbinaributton:Image
 
    {//לצורך הפונקציה שמחליפה את התמונה
      int flag=0;
      int muflag = 1; /*צליל*/
        public int isOne { get; set; } = 0;
        //int numberOfOnes = 0;
        ...
        public specialbinaributton() :base()
        {
        ...
        public specialbinaributton(Illustration Illustration, int a, int b, int c, int d, int num, int part) : base()
        {
            this.Source = new BitmapImage(new Uri(@"../../IMG1/00.png", UriKind.Relative));
        ...
        public specialbinaributton( int num, int part) : base()
        {
            this.Source = new BitmapImage(new Uri(@"../../IMG1/00.png", UriKind.Relative));
            this.MouseDown += binaributton_Mouseclick;
            string Name = "_" + num.ToString();
        ...
        void binaributton_Mouseclick(object sender, EventArgs e)
        {
            ...
            if (this.flag == 0)
            {
                ...
                int res=this.Illustration.checkBinaryArr();
                if (res == 0)
                {
                    isOne = 1;
